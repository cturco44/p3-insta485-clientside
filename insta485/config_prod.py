...
FLASKS3_DEBUG = True
FLASKS3_ACTIVE = True
FLASKS3_BUCKET_NAME = "danclee.static.insta485.com" # Use your own AWS bucket name
FLASKS3_REGION = "us-east-2"
FLASKS3_FORCE_MIMETYPE = True
FLASKS3_USE_HTTPS = False
FLASKS3_CDN_DOMAIN = "d31amjvxmoe4es.cloudfront.net" # Use your own CDN domain name

# AWS S3 file upload
AWS_S3_UPLOAD_BUCKET = "danclee.uploads.insta485.com" # Use your own uploads S3 bucket name
